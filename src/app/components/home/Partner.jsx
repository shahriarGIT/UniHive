...
const Partner = () => {
  return (
    <div className=" mt-[15rem] sm:mt-[12rem] md:mt-[2rem]">
      ...
      <div className=" bg-indigo-300  relative mx-auto md:ml-24 -mt-28 w-11/12 md:w-3/5 lg:w-2/5 p-10">
        <h2 className="text-2xl text-gray-900 ">Enjoy Learning </h2>
        <h3 className="text-lg text-gray-800 pt-8">
